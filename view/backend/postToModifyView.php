<?php $title = "Poste à modifier"; ?>

<?php ob_start(); ?>

<p><a class="postReturn" href="index.php?action=updateDeleteComment">Retour à la liste des billets</a></p>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <a href="index.php?action=openModifyTinyMce&amp;id=<?= $post['id'] ?>"><button type="submit" class="modifyBtn btn btn-success float-left ">Modifier l'article</button></a>
